...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImpressionistImageView imageView = (ImpressionistImageView) findViewById(R.id.viewImage);
    ...
    public void onCheckboxClickMotionBrushSize(View view) {
        _impressionistView.speedOfMotionCheckBox(((CheckBox) view).isChecked());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            try {
                ...
                ImageView imageView = (ImpressionistImageView) findViewById(R.id.viewImage);
